...
class DatasetLoader:
    ...
    def _load_master_data_if_needed(self):
        ...
        try:
            ...
            self._generate_combined_master_map(self._climate, self._environment_type)
    ...
    def load_environment(self, size: str) -> SARDatasetItem | None:
        ...
        radius_km =get_environment_radius_by_size(self._environment_type, self._climate, size)
        ...
        # Apply mask. The resulting map is NOT re-normalized, which is intentional.
        # The sum of the final heatmap will reflect the portion of the total probability.
